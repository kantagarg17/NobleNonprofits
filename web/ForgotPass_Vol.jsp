                        ...
                        <div class="card-body">
                            <form action="ForgetPass_Vol" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="newpassword" class="form-control" id="exampleInputPassword1" placeholder="Enter Password" required="">
                                </div>


                                <div class="form-group">
                                    <label for="exampleInputPassword1"> Confirm Password</label>
                                    <input type="password" name="conpassword" class="form-control" id="exampleInputPassword1" placeholder="Enter Password">
                                </div>
